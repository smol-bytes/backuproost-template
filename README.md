...
![Notion's New connection dialog with the name filled in and Access token selected](images/step-1-notion-connection.png)
...
![The connection's Content access tab, with Edit access on the right and top-level pages listed](images/step-2-content-access.png)
...
![GitHub repository settings showing Secrets and variables → Actions with a NOTION_TOKEN repository secret](images/step-3-github-secret.png)
...
![The Actions tab with the Notion backup workflow selected and the Run workflow button visible](images/step-4-run-workflow.png)
